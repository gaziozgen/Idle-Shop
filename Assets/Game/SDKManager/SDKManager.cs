...
public class SDKManager : MonoBehaviour
{
    ...
    private const string BannerAdUnitId = "3f1abac4829335a1";
    private const string InterstitialAdUnitId = "1c56126fd99d9567";
    private const string RewardedAdUnitId = "866932e7f03dfa57";
